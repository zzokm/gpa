...
`+PT(t.getShaderSource(e),o)}else return r}function DT(t,e){const n=LT(e);return[`vec4 ${t}( vec4 value ) {`,`	return ${n[1]}( vec4( value.rgb * ${n[0]}, value.a ) );`,"}"].join(`
`)}function NT(t,e){let n;switch(e){case ky:n="Linear";break;case By:n="Reinhard";break;case zy:n="Cineon";break;case Hy:n="ACESFilmic";break;case Gy:n="AgX";break;case Wy:n="Neutral";break;case Vy:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+t+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Aa=new H;function IT(){Ye.getLuminanceCoefficients(Aa);const t=Aa.x.toFixed(4),e=Aa.y.toFixed(4),n=Aa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${t}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
