 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,X){var Q=D.length;D.push(X);e:for(;0<Q;){var ae=Q-1>>>1,Se=D[ae];if(0<r(Se,X))D[ae]=X,D[Q]=Se,Q=ae;else break e}}function n(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var X=D[0],Q=D.pop();if(Q!==X){D[0]=Q;e:for(var ae=0,Se=D.length,Xe=Se>>>1;ae<Xe;){var W=2*(ae+1)-1,se=D[W],pe=W+1,oe=D[pe];if(0>r(se,Q))pe<Se&&0>r(oe,se)?(D[ae]=oe,D[pe]=Q,ae=pe):(D[ae]=se,D[W]=Q,ae=W);else if(pe<Se&&0>r(oe,Q))D[ae]=oe,D[pe]=Q,ae=pe;else break e}}return X}function r(D,X){var Q=D.sortIndex-X.sortIndex;return Q!==0?Q:D.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,p=!1,g=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(D){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=D)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function _(D){if(x=!1,y(D),!g)if(n(l)!==null)g=!0,$(P);else{var X=n(u);X!==null&&J(_,X.startTime-D)}}function P(D,X){g=!1,x&&(x=!1,c(A),A=-1),p=!0;var Q=f;try{for(y(X),h=n(l);h!==null&&(!(h.expirationTime>X)||D&&!L());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,f=h.priorityLevel;var Se=ae(h.expirationTime<=X);X=t.unstable_now(),typeof Se=="function"?h.callback=Se:h===n(l)&&i(l),y(X)}else i(l);h=n(l)}if(h!==null)var Xe=!0;else{var W=n(u);W!==null&&J(_,W.startTime-X),Xe=!1}return Xe}finally{h=null,f=Q,p=!1}}var R=!1,E=null,A=-1,w=5,M=-1;function L(){return!(t.unstable_now()-M<w)}function V(){if(E!==null){var D=t.unstable_now();M=D;var X=!0;try{X=E(!0,D)}finally{X?O():(R=!1,E=null)}}else R=!1}var O;if(typeof v=="function")O=function(){v(V)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,q=Y.port2;Y.port1.onmessage=V,O=function(){q.postMessage(null)}}else O=function(){m(V,0)};function $(D){E=D,R||(R=!0,O())}function J(D,X){A=m(function(){D(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,$(P))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(f){case 1:case 2:case 3:var X=3;break;default:X=f}var Q=f;f=X;try{return D()}finally{f=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,X){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var Q=f;f=D;try{return X()}finally{f=Q}},t.unstable_scheduleCallback=function(D,X,Q){var ae=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ae+Q:ae):Q=ae,D){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=Q+Se,D={id:d++,callback:X,priorityLevel:D,startTime:Q,expirationTime:Se,sortIndex:-1},Q>ae?(D.sortIndex=Q,e(u,D),n(l)===null&&D===n(u)&&(x?(c(A),A=-1):x=!0,J(_,Q-ae))):(D.sortIndex=Se,e(l,D),g||p||(g=!0,$(P))),D},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(D){var X=f;return function(){var Q=f;f=X;try{return D.apply(this,arguments)}finally{f=Q}}}})(hm);dm.exports=hm;var U_=dm.exports;/**
 * @license React
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `,transparent:!0}),a=new Rs(100,100,32,32),l=new Bn(a,o);l.rotation.x=Math.PI*.1,l.position.set(0,0,-2),n.add(l);const u=new Rs(120,120,16,16),d=new Qn({uniforms:{...s,uTime:{value:s.uTime.value+5},uVortexStrength:{value:s.uVortexStrength.value*.6},uBoundaryWave:{value:s.uBoundaryWave.value*.8},uNoiseIntensity:{value:s.uNoiseIntensity.value*.4},uBlurAmount:{value:s.uBlurAmount.value*1.1},uScatterFactor:{value:s.uScatterFactor.value*.9}},vertexShader:o.vertexShader,fragmentShader:o.fragmentShader,transparent:!0,opacity:.2}),h=new Bn(u,d);h.rotation.x=Math.PI*.08,h.position.set(0,0,-4),n.add(h),e.current={scene:n,camera:i,renderer:r};function f(){const x=requestAnimationFrame(f);e.current.animationId=x,s.uTime.value+=.005,d.uniforms.uTime&&(d.uniforms.uTime.value+=.003);const m=window.scrollY;e.current.scrollY=m;const c=m*.002;i.position.x=Math.sin(s.uTime.value*.1)*.1,i.position.y=Math.cos(s.uTime.value*.08)*.05-c,r.render(n,i)}f();const p=()=>{const x=Math.max(document.body.scrollHeight,document.documentElement.scrollHeight,document.body.offsetHeight,document.documentElement.offsetHeight,document.body.clientHeight,document.documentElement.clientHeight);i.aspect=window.innerWidth/window.innerHeight;const m=x/window.innerHeight;i.fov=Math.max(40,Math.min(60,40+m*5)),i.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)},g=()=>{};return window.addEventListener("resize",p),window.addEventListener("scroll",g),p(),()=>{window.removeEventListener("resize",p),window.removeEventListener("scroll",g),e.current.animationId&&cancelAnimationFrame(e.current.animationId),e.current.renderer&&e.current.renderer.dispose(),a&&a.dispose(),u&&u.dispose(),o&&o.dispose(),d&&d.dispose()}},[]),b.jsx("canvas",{ref:t,style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",zIndex:-1,pointerEvents:"none",willChange:"transform",backfaceVisibility:"hidden",transform:"translateZ(0)",transition:"opacity 0.3s ease-in",opacity:1}})},s_="gpa-calculator-courses",Tw=()=>{try{const t=localStorage.getItem(s_);return t?JSON.parse(t):[]}catch(t){return console.error("Failed to load courses from localStorage:",t),[]}},ww=()=>{const[t,e]=te.useState(Tw),[n,i]=te.useState(!1),[r,s]=te.useState({show:!1,message:""}),o=te.useCallback(()=>{e([]),s({show:!0,message:"All courses cleared!"}),setTimeout(()=>{s(p=>({...p,show:!1}))},1500)},[]),a=te.useCallback(p=>{const g=p.name.trim()||`Course ${t.length+1}`;e(x=>[...x,{...p,name:g,id:Date.now().toString(),isImported:!1}])},[t.length]),l=te.useCallback((p,g)=>{e(x=>x.map(m=>m.id===p?{...m,grade:g}:m))},[]),u=te.useCallback((p,g)=>{e(x=>x.map(m=>m.id===p?{...m,hours:g}:m)),s({show:!0,message:"Credit hours updated!"}),setTimeout(()=>{s(x=>({...x,show:!1}))},1500)},[]),d=te.useCallback(p=>{e(g=>g.filter(x=>x.id!==p))},[]),h=te.useCallback(p=>{const g=p.map(x=>({...x,id:Date.now().toString()+Math.random().toString()}));e(g),i(!1)},[]);te.useEffect(()=>{try{if(localStorage.setItem(s_,JSON.stringify(t)),t.length>0){const p=setTimeout(()=>{s(g=>({...g,show:!1}))},1500);return()=>clearTimeout(p)}}catch(p){console.error("Failed to save courses to localStorage:",p),s({show:!0,message:"Failed to save changes"});const g=setTimeout(()=>{s(x=>({...x,show:!1}))},1500);return()=>clearTimeout(g)}},[t]);const f=Av(t);return b.jsxs(b.Fragment,{children:["      ",b.jsxs(vv,{className:"container",children:[r.show&&b.jsx("div",{className:`save-notification ${r.message.includes("Failed")?"error":"success"}`,children:r.message}),b.jsxs("div",{children:[b.jsx("h1",{className:"app-title",children:"GPA Calculator"}),b.jsx("h5",{className:"app-subtitle",children:"FCAI - Cairo University"})]}),b.jsx(oy,{onAddCourse:a,onShowImport:()=>i(!0)}),"        ",b.jsx(fy,{courses:t,onRemoveCourse:d,onUpdateGrade:l,onUpdateCreditHours:u,onClearCourses:o}),b.jsx(hy,{gpa:f}),"        ",b.jsx(py,{show:n,onHide:()=>i(!1),onImport:h,currentCourses:t})]}),b.jsx(Ew,{})]})};Ku.createRoot(document.getElementById("root")).render(b.jsx(Uf.StrictMode,{children:b.jsx(ww,{})}));
