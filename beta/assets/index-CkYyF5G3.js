 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(N,Y){var Q=N.length;N.push(Y);e:for(;0<Q;){var ae=Q-1>>>1,Se=N[ae];if(0<r(Se,Y))N[ae]=Y,N[Q]=Se,Q=ae;else break e}}function n(N){return N.length===0?null:N[0]}function i(N){if(N.length===0)return null;var Y=N[0],Q=N.pop();if(Q!==Y){N[0]=Q;e:for(var ae=0,Se=N.length,qe=Se>>>1;ae<qe;){var q=2*(ae+1)-1,se=N[q],pe=q+1,oe=N[pe];if(0>r(se,Q))pe<Se&&0>r(oe,se)?(N[ae]=oe,N[pe]=Q,ae=pe):(N[ae]=se,N[q]=Q,ae=q);else if(pe<Se&&0>r(oe,Q))N[ae]=oe,N[pe]=Q,ae=pe;else break e}}return Y}function r(N,Y){var Q=N.sortIndex-Y.sortIndex;return Q!==0?Q:N.id-Y.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,h=null,d=3,p=!1,g=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(N){for(var Y=n(c);Y!==null;){if(Y.callback===null)i(c);else if(Y.startTime<=N)i(c),Y.sortIndex=Y.expirationTime,e(l,Y);else break;Y=n(c)}}function _(N){if(x=!1,y(N),!g)if(n(l)!==null)g=!0,$(P);else{var Y=n(c);Y!==null&&ee(_,Y.startTime-N)}}function P(N,Y){g=!1,x&&(x=!1,u(b),b=-1),p=!0;var Q=d;try{for(y(Y),h=n(l);h!==null&&(!(h.expirationTime>Y)||N&&!I());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,d=h.priorityLevel;var Se=ae(h.expirationTime<=Y);Y=t.unstable_now(),typeof Se=="function"?h.callback=Se:h===n(l)&&i(l),y(Y)}else i(l);h=n(l)}if(h!==null)var qe=!0;else{var q=n(c);q!==null&&ee(_,q.startTime-Y),qe=!1}return qe}finally{h=null,d=Q,p=!1}}var C=!1,M=null,b=-1,T=5,S=-1;function I(){return!(t.unstable_now()-S<T)}function U(){if(M!==null){var N=t.unstable_now();S=N;var Y=!0;try{Y=M(!0,N)}finally{Y?L():(C=!1,M=null)}}else C=!1}var L;if(typeof v=="function")L=function(){v(U)};else if(typeof MessageChannel<"u"){var W=new MessageChannel,j=W.port2;W.port1.onmessage=U,L=function(){j.postMessage(null)}}else L=function(){m(U,0)};function $(N){M=N,C||(C=!0,L())}function ee(N,Y){b=m(function(){N(t.unstable_now())},Y)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(N){N.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,$(P))},t.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):T=0<N?Math.floor(1e3/N):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(N){switch(d){case 1:case 2:case 3:var Y=3;break;default:Y=d}var Q=d;d=Y;try{return N()}finally{d=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(N,Y){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var Q=d;d=N;try{return Y()}finally{d=Q}},t.unstable_scheduleCallback=function(N,Y,Q){var ae=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?ae+Q:ae):Q=ae,N){case 1:var Se=-1;break;case 2:Se=250;break;case 5:Se=1073741823;break;case 4:Se=1e4;break;default:Se=5e3}return Se=Q+Se,N={id:f++,callback:Y,priorityLevel:N,startTime:Q,expirationTime:Se,sortIndex:-1},Q>ae?(N.sortIndex=Q,e(c,N),n(l)===null&&N===n(c)&&(x?(u(b),b=-1):x=!0,ee(_,Q-ae))):(N.sortIndex=Se,e(l,N),g||p||(g=!0,$(P))),N},t.unstable_shouldYield=I,t.unstable_wrapCallback=function(N){var Y=d;return function(){var Q=d;d=Y;try{return N.apply(this,arguments)}finally{d=Q}}}})(ym);_m.exports=ym;var G_=_m.exports;/**
 * @license React
...
`)+`
`+u);const y=v+m+o,_=v+u+a,P=Xp(r,r.VERTEX_SHADER,y),C=Xp(r,r.FRAGMENT_SHADER,_);r.attachShader(x,P),r.attachShader(x,C),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function M(I){if(t.debug.checkShaderErrors){const U=r.getProgramInfoLog(x).trim(),L=r.getShaderInfoLog(P).trim(),W=r.getShaderInfoLog(C).trim();let j=!0,$=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(j=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,C);else{const ee=Yp(r,P,"vertex"),N=Yp(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
