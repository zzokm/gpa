...
`)+`
`+c);const m=v+g+o,_=v+c+a,R=Bp(r,r.VERTEX_SHADER,m),A=Bp(r,r.FRAGMENT_SHADER,_);r.attachShader(y,R),r.attachShader(y,A),n.index0AttributeName!==void 0?r.bindAttribLocation(y,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(y,0,"position"),r.linkProgram(y);function T(P){if(t.debug.checkShaderErrors){const W=r.getProgramInfoLog(y).trim(),H=r.getShaderInfoLog(R).trim(),K=r.getShaderInfoLog(A).trim();let Q=!0,$=!0;if(r.getProgramParameter(y,r.LINK_STATUS)===!1)if(Q=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,y,R,A);else{const J=zp(r,R,"vertex"),N=zp(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(y,r.VALIDATE_STATUS)+`
